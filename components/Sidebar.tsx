...
export default function Sidebar({ onDocumentadorClick }: { onDocumentadorClick?: () => void }) {
  ...
  useEffect(() => {
    // Siempre expandido en aceleradores, colapsado en home por defecto
      ...
      <div className="h-10 sm:h-12 flex items-center justify-between px-2 sm:px-4 border-b">
        {open && (
          <div className="flex items-center gap-2">
            <Image src="/icons/acelerador.png" alt="Aceleradores" width={25} height={25} className={`sm:w-6 sm:h-6 ${styles.iconAzulSombra}`} />
